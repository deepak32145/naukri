...
const { register, login, logout, verifyEmail, resendOtp, forgotPassword, resetPassword, googleCallback, sendLoginOtp, verifyLoginOtp } = require('../controllers/auth.controller');
